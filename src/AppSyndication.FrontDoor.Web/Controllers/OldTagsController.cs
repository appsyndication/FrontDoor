...
namespace AppSyndication.Web.Controllers
{
    ...
    [Route("[controller]")]
    public class OldTagsController : Controller
    {
        ...
        public OldTagsController(ILoggerFactory loggerFactory, ITagIndex tagIndex)
        {
            _logger = loggerFactory.CreateLogger<OldTagsController>();
